...
function appendActivityPopup(url, selector, callback) {
    if (jQuery('span#ui_popup_dialog').size() == 0){
      jQuery.get(url, { }, function(data) {
        var html = "<span style='display: none' id='ui_popup_dialog'>"+ data +"</span>"
        jQuery(selector).prepend(html);
...
jQuery(document).ready(function() {
  ...
  autocomplete('#milestone_project_name_autocomplete','/sprint_planning/auto_complete_for_milestone_project_name',addProjectToMilestone);
...
function addProjectToMilestone(event, ui){
    jQuery('#project_id').val(ui.item.id);
}
...
function reload_planning_backlog(sender,tab){
...
function reload_milestone_planning_backlog(milestone_id,project_id,tab){
//    window.location.href = "/task_filters/update_current_filter?tab="+tab+"&task_filter[qualifiers_attributes][][qualifiable_id]="+sender+"&task_filter[qualifiers_attributes][][qualifiable_type]=Project&task_filter[qualifiers_attributes][][qualifiable_id]=0&task_filter[qualifiers_attributes][][qualifiable_type]=Milestone&backlog=planning&project_id="+sender;
    window.location = "/sprint_planning/planning?milestone_id=" + milestone_id+"&project_id="+project_id+"&tab="+tab;
}

function reload_taskboard(project_id){
//    window.location.href = "/task_filters/update_current_filter?tab="+tab+"&task_filter[qualifiers_attributes][][qualifiable_id]="+sender+"&task_filter[qualifiers_attributes][][qualifiable_type]=Project&task_filter[qualifiers_attributes][][qualifiable_id]=0&task_filter[qualifiers_attributes][][qualifiable_type]=Milestone&backlog=planning&project_id="+sender;
    window.location = "/sprint_monitoring/taskboard?project_id=" + project_id;
}

function reload_meeting_project(project_id,tab){
//    window.location.href = "/task_filters/update_current_filter?tab="+tab+"&task_filter[qualifiers_attributes][][qualifiable_id]="+sender+"&task_filter[qualifiers_attributes][][qualifiable_type]=Project&task_filter[qualifiers_attributes][][qualifiable_id]=0&task_filter[qualifiers_attributes][][qualifiable_type]=Milestone&backlog=planning&project_id="+sender;
...
//    window.location.href = "/task_filters/update_current_filter?tab="+tab+"&task_filter[qualifiers_attributes][][qualifiable_id]="+sender+"&task_filter[qualifiers_attributes][][qualifiable_type]=Project&task_filter[qualifiers_attributes][][qualifiable_id]=0&task_filter[qualifiers_attributes][][qualifiable_type]=Milestone&backlog=planning&project_id="+sender;
    window.location = "/sprint_monitoring/monitoring?milestone_id=" + milestone_id +"&project_id="+project_id;
}

function reload_monitoring_project(project_id,tab){
//    window.location.href = "/task_filters/update_current_filter?tab="+tab+"&task_filter[qualifiers_attributes][][qualifiable_id]="+sender+"&task_filter[qualifiers_attributes][][qualifiable_type]=Project&task_filter[qualifiers_attributes][][qualifiable_id]=0&task_filter[qualifiers_attributes][][qualifiable_type]=Milestone&backlog=planning&project_id="+sender;
