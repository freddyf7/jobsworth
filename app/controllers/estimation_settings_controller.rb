class EstimationSettingsController < ApplicationController
  ...
  def index
    @estimation_settings = EstimationSetting.all

    respond_to do |format|
      format.html # index.html.erb
      format.xml  { render :xml => @estimation_settings }
    end
  end
  ...
  def create
    ...
    respond_to do |format|
      if @estimation_setting.save
        format.html { redirect_to(@estimation_setting, :notice => 'Estimation setting was successfully created.') }
