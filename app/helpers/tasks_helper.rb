...
module TasksHelper
  ...
  def options_for_user_projects_backlog (selected_project)
  ...
  def finished_iteration_options(project_id,selected_milestone)
    hoy = Date.today
    finish_hoy = DateTime.new(hoy.year,hoy.month,hoy.day,23,59,59)
